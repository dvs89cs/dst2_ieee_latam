###############################################################################
# El código corresponde al artículo "A new method for 2-D adapted wavelet construction: 
# an application on mass type anomalies localization in mammographic images" sometido a MDPI (2023).
